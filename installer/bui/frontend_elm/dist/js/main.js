...
var _user$project$Main$ignoreResponseBody = _elm_lang$http$Http$expectStringResponse(
	function (response) {
		return _elm_lang$core$Result$Ok(
			{ctor: '_Tuple0'});
	});
var _user$project$Main$postAndIgnoreResponseBody = F2(
	function (url, body) {
		return _elm_lang$http$Http$request(
			{
				method: 'POST',
				...
				url: url,
				body: body,
				expect: _user$project$Main$ignoreResponseBody,
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
	});
var _user$project$Main$postCallback = function (body) {
	return A2(_user$project$Main$postAndIgnoreResponseBody, '/callback', body);
};
var _user$project$Main$callbackEncoded = F3(
	function (token, name, args) {
		var list = {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'args', _1: args},
					_1: {ctor: '[]'}
				}
			}
		};
				...
				A2(
					...
					_elm_lang$core$List$reverse(
						A2(
							...
							'\n',
							_elm_lang$core$String$trimRight(str))))));
	});
var _user$project$Main$default_server_state = {
	error: '',
	mysql_connect: '',
	grafana_url: '',
	command: _elm_lang$core$Maybe$Nothing,
	cluster_info: {ctor: '[]'}
};
var _user$project$Main$openWindow = _elm_lang$core$Native_Platform.outgoingPort(
	'openWindow',
	function (v) {
		return v;
	});
var _user$project$Main$event_source_data = _elm_lang$core$Native_Platform.incomingPort('event_source_data', _elm_lang$core$Json_Decode$string);
var _user$project$Main$ready_state = _elm_lang$core$Native_Platform.incomingPort('ready_state', _elm_lang$core$Json_Decode$int);
var _user$project$Main$RunningCommand = F4(
	function (a, b, c, d) {
		return {command: a, output: b, error: c, exit_code: d};
	});
var _user$project$Main$decodeRunningCommand = A5(
	_elm_lang$core$Json_Decode$map4,
	_user$project$Main$RunningCommand,
	A2(
		_elm_lang$core$Json_Decode$field,
		'command',
		_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string)),
	A2(_elm_lang$core$Json_Decode$field, 'output', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'error', _elm_lang$core$Json_Decode$string),
	A2(
		_elm_lang$core$Json_Decode$field,
		'exit_code',
		_elm_lang$core$Json_Decode$nullable(_elm_lang$core$Json_Decode$int)));
var _user$project$Main$ServerState = F5(
	function (a, b, c, d, e) {
		return {error: a, mysql_connect: b, grafana_url: c, command: d, cluster_info: e};
	});
var _user$project$Main$decodeServerState = A6(
	_elm_lang$core$Json_Decode$map5,
	_user$project$Main$ServerState,
	A2(_elm_lang$core$Json_Decode$field, 'error', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'mysql_connect', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'grafana_url', _elm_lang$core$Json_Decode$string),
	A2(
		_elm_lang$core$Json_Decode$field,
		'running',
		_elm_lang$core$Json_Decode$nullable(_user$project$Main$decodeRunningCommand)),
	A2(
		_elm_lang$core$Json_Decode$field,
		'cluster_info',
		_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string)));
...
var _user$project$Main$Model = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {server_state: a, steps: b, running_step: c, fail_msg: d, mdl: e, token: f, ready_state: g, ui_state: h, kube_services: i};
	});
var _user$project$Main$KubeMetaData = function (a) {
	return {name: a};
};
var _user$project$Main$decodeKubeMetaData = A2(
	_elm_lang$core$Json_Decode$map,
	_user$project$Main$KubeMetaData,
	A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string));
var _user$project$Main$KubeStatefulSet = function (a) {
	return {metadata: a};
};
var _user$project$Main$decodeKubeStatefulSet = A2(
	_elm_lang$core$Json_Decode$map,
	_user$project$Main$KubeStatefulSet,
	A2(_elm_lang$core$Json_Decode$field, 'metadata', _user$project$Main$decodeKubeMetaData));
var _user$project$Main$KubeStatefulSets = function (a) {
	return {items: a};
};
var _user$project$Main$decodeKubeStatefulSets = A2(
	_elm_lang$core$Json_Decode$map,
	_user$project$Main$KubeStatefulSets,
	A2(
		_elm_lang$core$Json_Decode$field,
		'items',
		_elm_lang$core$Json_Decode$list(_user$project$Main$decodeKubeStatefulSet)));
...
var _user$project$Main$to_ready_state = function (code) {
	var _p0 = code;
	switch (_p0) {
		case 0:
			return _elm_lang$core$Result$Ok(_user$project$Main$Connecting);
		case 1:
			return _elm_lang$core$Result$Ok(_user$project$Main$Open);
		case 2:
			return _elm_lang$core$Result$Ok(_user$project$Main$Closed);
		default:
			return _elm_lang$core$Result$Err('unknown ReadyState code');
	}
};
...
var _user$project$Main$activeStep = function (step) {
	return _elm_lang$core$Native_Utils.eq(step.status, _user$project$Main$Running) || _elm_lang$core$Native_Utils.eq(step.status, _user$project$Main$Next);
};
var _user$project$Main$active_step = function (model) {
	return _elm_lang$core$List$head(
		A2(_elm_lang$core$List$filter, _user$project$Main$activeStep, model.steps));
};
var _user$project$Main$init = {
	...
	_0: {
		...
		server_state: _user$project$Main$default_server_state,
		running_step: _elm_lang$core$Maybe$Nothing,
		steps: {
			ctor: '::',
			_0: {name: 'kube-up', recipe: 'kube-resources', status: _user$project$Main$Next, description: '\nBring up a simulated cluster on Kubernetes via Minikube.\nBuilds an ansible docker image for the deploy steps.\nBuilds a centos docker image to simulate servers.\n'},
			_1: {
				ctor: '::',
				_0: {name: 'prepare', recipe: 'ansible-prepare', status: _user$project$Main$Idle, description: 'Run ansible prepare. This could take a while to download tidb binares.'},
				_1: {
					ctor: '::',
					_0: {name: 'bootstrap', recipe: 'ansible-bootstrap', status: _user$project$Main$Idle, description: '\nRun ansible bootstrap. Sets up hosts for deployment.\n'},
					_1: {
						ctor: '::',
						_0: {name: 'deploy', recipe: 'ansible-deploy', status: _user$project$Main$Idle, description: '\nRun ansible deploy. Provisions machines with TiDB services.\n'},
						_1: {
							ctor: '::',
							_0: {name: 'start', recipe: 'ansible-start', status: _user$project$Main$Idle, description: '\nRun ansible start. Starts up TiDB services.\n'},
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Main$updateSteps = F4(
	function (nextStatus, runningStatus, recipe, steps) {
		var _p1 = steps;
		if (_p1.ctor === '[]') {
			return {ctor: '[]'};
		} else {
			var _p4 = _p1._0;
			var isStep = _elm_lang$core$Native_Utils.eq(recipe, _p4.recipe);
			var status = function () {
				if (isStep) {
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					...
					{status: status}),
				_1: A4(
					_user$project$Main$updateSteps,
					function () {
						if (isStep) {
							return _elm_lang$core$Native_Utils.eq(runningStatus, _user$project$Main$Completed) ? _elm_lang$core$Maybe$Just(_user$project$Main$Next) : _elm_lang$core$Maybe$Just(_user$project$Main$Idle);
						} else {
							var _p3 = nextStatus;
							if (_p3.ctor === 'Nothing') {
								return _elm_lang$core$Maybe$Nothing;
							} else {
								return _elm_lang$core$Maybe$Just(_user$project$Main$Idle);
							}
						}
					}(),
					runningStatus,
...
var _user$project$Main$update_steps = function (model) {
	var _p5 = model.server_state.command;
	if (_p5.ctor === 'Nothing') {
		return model;
	} else {
		var _p10 = _p5._0;
		var status = function () {
			var _p6 = _p10.exit_code;
			if (_p6.ctor === 'Nothing') {
		...
		var _p7 = _p10.command;
		if ((((_p7.ctor === '::') && (_p7._0 === 'just')) && (_p7._1.ctor === '::')) && (_p7._1._1.ctor === '[]')) {
			var _p9 = _p7._1._0;
			return A2(
				_elm_lang$core$List$any,
				function (step) {
					return _elm_lang$core$Native_Utils.eq(step.recipe, _p9);
				},
				model.steps) ? _elm_lang$core$Native_Utils.update(
				model,
				{
					fail_msg: '',
					running_step: function () {
						var _p8 = _p10.exit_code;
						if (_p8.ctor === 'Nothing') {
					...
					steps: A4(_user$project$Main$updateSteps, _elm_lang$core$Maybe$Nothing, status, _p9, model.steps)
				}) : _elm_lang$core$Native_Utils.update(
				model,
				{
					fail_msg: A2(_elm_lang$core$String$append, 'did not find step: ', _p9),
					running_step: _elm_lang$core$Maybe$Nothing
				});
		} else {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					...
					fail_msg: A2(
						...
						'unknown command: ',
						A2(_elm_lang$core$String$join, ' ', _p10.command))
				});
		}
	}
};
...
var _user$project$Main$KubeApi = function (a) {
	return {ctor: 'KubeApi', _0: a};
};
var _user$project$Main$get_kubernetes_data = A2(
	_elm_lang$http$Http$send,
	_user$project$Main$KubeApi,
	A2(_elm_lang$http$Http$get, '/api/v1/statefulsets', _user$project$Main$decodeKubeStatefulSets));
var _user$project$Main$CallbackDone = function (a) {
	return {ctor: 'CallbackDone', _0: a};
};
var _user$project$Main$send_message = F3(
	function (model, name, args) {
		var body = _elm_lang$http$Http$jsonBody(
			A3(_user$project$Main$callbackEncoded, model.token, name, args));
		return A2(
			_elm_lang$http$Http$send,
			_user$project$Main$CallbackDone,
			_user$project$Main$postCallback(body));
	});
var _user$project$Main$do_command = F2(
	function (model, command) {
		return A3(
			_user$project$Main$send_message,
			model,
			command,
...
var _user$project$Main$NewReadyState = function (a) {
	return {ctor: 'NewReadyState', _0: a};
};
var _user$project$Main$FailedDecode = function (a) {
...
var _user$project$Main$InstallCommand = function (a) {
	return {ctor: 'InstallCommand', _0: a};
};
var _user$project$Main$stepView = F3(
	function (model, k, step) {
		...
		return A5(
			...
			model.mdl,
			{
				...
				_1: {
					...
					_0: _debois$elm_mdl$Material_Options$disabled(
						!_elm_lang$core$Native_Utils.eq(step.status, _user$project$Main$Next)),
					_1: {
						ctor: '::',
						_0: _debois$elm_mdl$Material_Options$onClick(
							_user$project$Main$InstallCommand(step.recipe)),
						_1: {
							ctor: '::',
							_0: A2(_debois$elm_mdl$Material_Options$css, 'width', '10em'),
							_1: {
								ctor: '::',
								_0: A2(_debois$elm_mdl$Material_Options$css, 'margin', '1em'),
								_1: {
									ctor: '::',
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _user$project$Main$activeStep(step) ? _debois$elm_mdl$Material_Elevation$e8 : _debois$elm_mdl$Material_Elevation$e2,
											_1: {ctor: '[]'}
										}
									}
								}
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(step.name),
				_1: {ctor: '[]'}
			});
	});
var _user$project$Main$viewInstallTab = function (model) {
	return A2(
		_debois$elm_mdl$Material_Grid$grid,
		{ctor: '[]'},
		{
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Kubernetes Simulated Cluster Deployment'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									A2(
										...
										F2(
											function (i, sq) {
												return A3(_user$project$Main$stepView, model, i + 1, sq);
											}),
										model.steps)),
								_1: {
									ctor: '::',
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(model.fail_msg),
												_1: {
													ctor: '::',
													_0: A2(
														_elm_lang$html$Html$pre,
														{ctor: '[]'},
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text(
																_user$project$Main$defaultEmpty(
																	A2(
																		_elm_lang$core$Maybe$map,
																		function (c) {
																			return c.error;
																		},
																		model.server_state.command))),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
											...
											_0: A2(
												...
												},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: A2(_debois$elm_mdl$Material_Options$css, 'overflow-x', 'scroll'),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
	...
	return A3(
		...
		A4(
			...
			model.mdl,
			{
				...
				_1: {
					ctor: '::',
					_0: _debois$elm_mdl$Material_Layout$selectedTab(model.ui_state.selected_tab),
					_1: {
						ctor: '::',
						_0: _debois$elm_mdl$Material_Layout$onSelectTab(
							function (msg) {
								return _user$project$Main$UIMsg(
									_user$project$Main$SelectTab(msg));
							}),
						_1: {ctor: '[]'}
					}
				}
			},
			{
				header: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('TiDB Installer'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				},
				...
				tabs: {
					...
					_0: {
						ctor: '::',
						_0: _elm_lang$html$Html$text('Deploy Simulator'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html$text('View Cluster'),
							_1: {ctor: '[]'}
						}
					},
					_1: {
				...
				main: {
					...
					_0: function () {
						...
						switch (_p27) {
							...
							case 1:
								return _user$project$Main$viewClusterTab(model);
							default:
								return A2(
									_debois$elm_mdl$Material_Grid$grid,
									{ctor: '[]'},
...
var _user$project$Main$NewToken = function (a) {
	return {ctor: 'NewToken', _0: a};
};
var _user$project$Main$NewServerState = function (a) {
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Main$event_source_data(_user$project$Main$getServerStateOrFail),
				_1: {
					ctor: '::',
					_0: _user$project$Main$ready_state(_user$project$Main$decodeReadyState),
					_1: {ctor: '[]'}
				}
			}
		});
